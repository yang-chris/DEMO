...
var
	...
	// Support: IE<9
	// For `typeof nodejs.method` instead of `nodejs.method !== undefined`
...
jQuery.support = (function() {
	...
	jQuery(function() {
		...
		// Use window.getComputedStyle because jsdom on nodejs.js will break without it.
	...
	get: function( elem, name ) {
		var
			...
			detail = typeof prop === "boolean" ?
				...
				// fetch an attribute nodejs for properties not recognized as boolean
...
jQuery.event = {
	...
	fix: function( event ) {
		...
		// Target should not be a text nodejs (#504, #13143)
...
jQuery.extend({
	...
	ajax: function( url, options ) {
		...
		var // Cross-domain detection vars
			...
			// Context for global events is callbackContext if it is a DOM nodejs or jQuery collection
